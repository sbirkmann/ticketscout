...
- **Interaktive Map-Ansicht (Frontend)**
  - [ ] Leaflet.js Karte auf der "Locations" Seite einbinden
  - [ ] Marker für alle aktiven Locations mit Event-Vorschau
- **Globales Gutschein-System (Superadmin)**
  - [ ] Wertgutscheine (Gift Cards) im Admin-Dashboard generieren
  - [ ] Einlösen von Plattform-Gutscheinen im Checkout (unabhängig vom Vendor)

### User Input (2026-05-09):
- "tasks weiter bearbeiten" -> Neue Tasks aus der Roadmap ausgewählt (Gutschein-Kampagnen & Favoriten).
...
- [ ] **Interaktive Platzauswahl (Saalplan)**: Visueller Saalplan im Checkout zur punktgenauen Sitzplatzauswahl.
- [ ] **Platzauswahl-Regeln**: Verhinderung von isolierten Einzelplätzen (Orphan Seats) bei der Buchung.
...
- [ ] **Interaktive Map-Ansicht**: Events in der Umgebung auf einer Karte entdecken.
- [ ] **Gruppen-Käufe**: Tickets reservieren und Link an Freunde senden, damit diese ihren Teil zahlen.
- [ ] **Ticket-Weiterverkauf (Fan-to-Fan)**: Offizieller und sicherer Resale-Marktplatz für Kunden.
- [ ] **Geschenk-Modus**: Tickets mit personalisierter digitaler Grußkarte als Geschenk versenden.
- [ ] **Erinnerungen**: E-Mail-Erinnerung 24h vor dem Event (mit Wetter, Anfahrt).
- [ ] **Apple Wallet / Google Wallet Integration**: Tickets direkt ins Handy-Wallet laden.
- [ ] **Dark Mode Unterstützung**: Vollständiges Dark-Theme für das gesamte Frontend.
- [x] **Erweiterte Filter**: Nach Datum, Preis, Tags, Barrierefreiheit, etc. filtern.
- [ ] **Kunden-Treueprogramm (Loyalty)**: Punkte sammeln für jeden Kauf, einlösbar für Rabatte.
...
- [ ] **Abandoned Cart Recovery**: Automatische E-Mails an Kunden, die den Checkout abgebrochen haben.
...
- [ ] **Massen-Bearbeitung**: Mehrere Events gleichzeitig bearbeiten (z.B. Status ändern).
- [ ] **Staff-Accounts**: Teammitglieder mit limitierten Rechten (z.B. nur Einlass) hinzufügen.
- [ ] **Custom Domains / White-Label**: Vendor-Landingpage unter eigener Domain hosten.
- [x] **Echtzeit Check-in Tracker**: Live-Statistiken am Event-Tag (Wie viele sind schon drin?).
- [ ] **Affiliate-Links (Tracking)**: Spezielle Links erstellen, um zu sehen, welche Promo-Aktion am besten funktioniert.
- [ ] **Dynamisches Pricing**: Preise steigen automatisch, wenn nur noch X Tickets da sind.

#### Superadmin Dashboard
- [x] **Globales Banner-Management**: Ankündigungs-Banner für die ganze Seite im Admin aktivieren.
- [ ] **Auszahlungs-System (Payouts)**: Kontrolle, wann Vendors ihr Geld erhalten (z.B. erst nach Event-Ende).
- [x] **System Health / Logs**: Übersicht über Fehler, gescheiterte E-Mails, Stripe-Webhook-Status.
- [ ] **Erweiterte Steuerexporte**: DATEV-kompatible Exporte für die Buchhaltung.
- [ ] **Content Moderation Queue**: Neue Events müssen erst freigegeben werden, bevor sie online gehen.
- [ ] **Globales Gutschein-System**: Plattform-weite Geschenkgutscheine verwalten.
- [ ] **User Masquerading**: Als Admin in das Konto eines Vendors einloggen, um Support zu leisten.
- [ ] **Umfangreiches Audit-Log**: Wer hat wann was geändert?
