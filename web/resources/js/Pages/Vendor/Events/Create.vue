...
const submit = () => {
    form.post(route('vendor.events.store'));
};
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <h2 class="font-semibold text-2xl text-surface-900 leading-tight font-display">Neues Event erstellen</h2>
            </div>
        </template>
                    ...
                    <form @submit.prevent="submit" class="p-8 space-y-8" enctype="multipart/form-data">
                        ...
                        <div class="pt-6 border-t border-surface-200 flex items-center justify-between">
                            ...
                            <div class="flex gap-3">
                                <Link :href="route('vendor.events.index')" class="px-6 py-2.5 rounded-full font-medium text-surface-600 hover:bg-surface-100 transition-colors">
                                    Abbrechen
                                </Link>
